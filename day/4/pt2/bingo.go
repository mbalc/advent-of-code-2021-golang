...
func main() {
	...
	var lastWinningInput int

	// fmt.Println(boards)
	// fmt.Println()

	for _, input := range inputs {
		var newBoards []bingoBoard
	...
	// fmt.Println(lastWinningInput, lastWinningBoard)
	unmarkedSum := calculateBoardUmarkedFieldsSum(lastWinningBoard)
	fmt.Println(unmarkedSum * lastWinningInput)
}
